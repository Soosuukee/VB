...
type Match struct {
	...
	MatchType  *string `gorm:"size:50" json:"match_type,omitempty"`     // ex: "Bo1", "Bo3", "Battle Royale", "Custom"

	// Infos de lobby
	RoundLabel string  `gorm:"size:255;not null" json:"round_label"` // ex: "Finale", "Round 3"
	LobbyCode  *string `gorm:"size:20" json:"lobby_code,omitempty"`  // ex: code pour rejoindre le lobby
